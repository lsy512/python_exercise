...
class Calculator(wx.Frame):  
	def __init__(self):  
		wx.Frame.__init__(self,None,-1,"calculater",size=(350,480),style=wx.DEFAULT_FRAME_STYLE^(wx.RESIZE_BORDER|wx.MINIMIZE_BOX|wx.MAXIMIZE_BOX))
		panel = wx.Panel(self)  
        	...
        	def OnAc(self,event):  
       		...
       		def OnTarget(self,event):  
            		...
            		try:  
                		...
                		dlg = wx.MessageDialog(self,'wrong data ','please whatch out',  
